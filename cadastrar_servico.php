            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editar_servico.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning">Editar</a>
                            <a href="excluir_servico.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Tem certeza que deseja excluir?');">Excluir</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
